...
psi = fltarr(nx,ny,nz,ns)
psi_tot = fltarr(nx,ny,nz,ns)
...
psi(*,iy + iprocy * nyl,iz + iprocz * nzl,it) = work(*,iy,iz)
psi_tot(*,iy + iprocy * nyl,iz + iprocz * nzl,it) = work(*,iy,iz)-eq_ampl*alog(cosh(x(*)/eq_l))+asym*yl/zl*x(*)
by(*,iy + iprocy * nyl,iz + iprocz * nzl,it) = deriv(x,psi_tot(*,iy + iprocy * nyl,iz + iprocz * nzl,it))
endfor
endfor

...
corr = fltarr(m)
difference = fltarr(m)
corr = [0,0.0194049,0.0338681,0.0422611,0.0450473,0.0432661,0.0379827,0.0301540,0.0208728,0.0116367,0.00403094]
;print, 'correct growth rate='
oplot, corr(1:m-1),line=2
...
;if (difference(*)<0.00001) then begin
;print, 'TEST PASSED'
;endif else begin
;print, 'TEST FAILED'
;endelse
